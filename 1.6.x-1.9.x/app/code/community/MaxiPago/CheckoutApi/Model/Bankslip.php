...
class MaxiPago_CheckoutApi_Model_Bankslip extends MaxiPago_CheckoutApi_Model_Standard
{
    protected $_code  = 'maxipagocheckoutapi_bankslip';
    ...
    protected $_standardType = 'bankslip';
