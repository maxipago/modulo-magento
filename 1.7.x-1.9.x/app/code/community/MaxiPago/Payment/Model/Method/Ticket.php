 ...
 *
 */
class MaxiPago_Payment_Model_Method_Ticket extends MaxiPago_Payment_Model_Method_Abstract
{
    protected $_code = 'maxipago_ticket';

    protected $_formBlockType = 'maxipago/form_ticket';
    protected $_infoBlockType = 'maxipago/info_ticket';
    ...
    public function order(Varien_Object $payment, $amount)
    {
        ...
        try {
            ...
            $response = $api->ticketMethod($this, $payment, $amount);
    ...
    {
        $banks = $this->_getHelper()->getConfig('banks', $this->getCode());
        if (empty($banks)) {
            return false;
        }
